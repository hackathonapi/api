...
def generate_clearview(
    ...
    # When OpenAI responded, render only AI sections on this analysis page.
    # Otherwise render fallback summary + backup notes.
    if ai_sections:
        pdf.set_font("Helvetica", "I", 8.5)
        pdf.set_text_color(150, 150, 150)
        pdf.cell(_TEXT_WIDTH, 5, txt="AI-generated analysis (OpenAI gpt-4o-mini)", align="L")
        pdf.ln(10)
